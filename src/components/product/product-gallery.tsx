    ...
    <div className="w-full space-y-4">
      ...
      >
        ...
        <img
          key={activeImage}
          src={activeImage}
          alt={t("product.mainPhotoAlt", { name: localized.name, number: selectedIndex + 1 })}
          ...
          {images.map((imgUrl, index) => {
            ...
            return (
              <button
                ...
                aria-label={t("product.selectPhoto", { number: index + 1 })}
              ...
              >
                <img
                  src={imgUrl}
                  alt={t("product.thumbnail", { name: localized.name, number: index + 1 })}
