  ...
  if (orders.length === 0) {
    return (
      <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center max-w-md mx-auto space-y-4 shadow-xs">
        ...
        <h3 className="text-lg font-bold text-slate-900">{t("account.noOrdersTitle")}</h3>
              ...
              <div className="space-y-1.5 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-y-1 gap-x-4 text-xs text-slate-500">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>
                      {order.items.reduce((acc, i) => acc + i.quantity, 0)} {t("account.itemsShort")}
                    </span>
                  </div>
                </div>
              </div>
